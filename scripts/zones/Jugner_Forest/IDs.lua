...
zones[xi.zone.JUGNER_FOREST] =
{
    text =
    {
        ...
        FISHING_MESSAGE_OFFSET        = 7722,  -- You can't fish here.
        DIG_THROW_AWAY                = 7735,  -- You dig up <item>, but your inventory is full. You regretfully throw the <item> away.
        ...
        GARRISON_BASE                 = 8434,  -- Hm? What is this? %? How do I know this is not some [San d'Orian/Bastokan/Windurstian] trick?
        ...
        VOIDWALKER_DESPAWN            = 8696,  -- The monster fades before your eyes, a look of disappointment on its face.
        UNITY_WANTED_BATTLE_INTERACT  = 8727,  -- Those who have accepted % must pay # Unity accolades to participate. The content for this Wanted battle is #. [Ready to begin?/You do not have the appropriate object set, so your rewards will be limited.]
        REGIME_REGISTERED             = 10870, -- New training regime registered!
        DRAWN_UNWANTED_ATTENTION      = 11924, -- Your presence has drawn unwanted attention!
        SENSE_UNUSUAL_PRESENCE        = 11926, -- You sense an unusual presence in the area...
        DELIVER_TO_AMAURE             = 11928, -- You must deliver the <item> to Amaura in Southern San d'Oria.
        VOIDWALKER_NO_MOB             = 12088, -- The <keyitem> quivers ever so slightly, but emits no light. There seem to be no monsters in the area.
        VOIDWALKER_MOB_TOO_FAR        = 12089, -- The <keyitem> quivers ever so slightly and emits a faint light. There seem to be no monsters in the immediate vicinity.
        VOIDWALKER_MOB_HINT           = 12090, -- The <keyitem> resonates [feebly/softly/solidly/strongly/very strongly/furiously], sending a radiant beam of light lancing towards a spot roughly <number> [yalm/yalms] [east/southeast/south/southwest/west/northwest/north/northeast] of here.
        VOIDWALKER_SPAWN_MOB          = 12091, -- A monster materializes out of nowhere!
        VOIDWALKER_UPGRADE_KI_1       = 12093, -- The <keyitem> takes on a slightly deeper hue and becomes <keyitem>!
        VOIDWALKER_UPGRADE_KI_2       = 12094, -- The <keyitem> takes on a deeper, richer hue and becomes <keyitem>!
        VOIDWALKER_BREAK_KI           = 12095, -- The <keyitem> shatters into tiny fragments.
